...
import SellerOrdersSkeleton from '../../components/sellerOrders/SellerOrdersSkeleton';
...
const SellerOrdersPage = () => {
    ...
    const fetchOrders = async () => {
        try {
            ...
            const response = await sellerOrderApi.sellerGetOrders(params);
            ...
            <div className="container mx-auto px-4 max-w-5xl">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-slate-500">View and update status of incoming orders</p>
                    </div>
                </div>
