...
public class BuyerProfileService {
        ...
        @Transactional
        public BuyerProfileDto.BuyerProfileResponse updateProfile(UUID userId,
                        BuyerProfileDto.UpdateBuyerProfileRequest request) {
                User user = userRepository.findById(userId)
                                .orElseThrow(() -> new ResourceNotFoundException("User", userId.toString()));
                ...
                if (request.getCountry() != null && !request.getCountry().equals(profile.getCountry())) {
                        ...
                        profile.setPreferredCurrency(currencyService.getCurrencyForCountry(request.getCountry()));
                }
                ...
                // Allow explicit currency update if provided
