...
import com.IndiExport.backend.service.currency.CurrencyService;
...
public class AuthService {
        ...
        public SignupResponse signupBuyer(SignupBuyerRequest request) {
                ...
                User user = User.builder()
                                ...
                                .firstName(request.getFirstName() != null ? request.getFirstName() : "Buyer")
                ...
                BuyerProfile buyerProfile = BuyerProfile.builder()
                                ...
                                .preferredCurrency(currencyService.getCurrencyForCountry(request.getCountry()))
                                .build();
        ...
        public SignupResponse signupSeller(SignupSellerRequest request) {
                ...
                User user = User.builder()
                                .email(request.getEmail())
                                .passwordHash(passwordEncoder.encode(request.getPassword()))
                                .firstName(request.getFirstName() != null ? request.getFirstName() : "Seller")
                                .lastName(request.getLastName() != null ? request.getLastName() : "User")
                                .phoneNumber(request.getPhoneNumber())
                                .status(User.UserStatus.ACTIVE)
                ...
                SellerProfile sellerProfile = SellerProfile.builder()
                                ...
                                .address(request.getAddress() != null ? request.getAddress() : "Pending Update")
                                .city(request.getCity() != null ? request.getCity() : "Pending")
                                .state(request.getState() != null ? request.getState() : "Pending")
                                .postalCode(request.getPostalCode() != null ? request.getPostalCode() : "000000")
                                .country(request.getCountry() != null ? request.getCountry() : "IN")
        ...
        public MeResponse getCurrentUser(UUID userId) {
                ...
                if (roles.contains("SELLER") && user.getSellerProfile() != null) {
                        ...
                        response.setSellerDetails(MeResponse.SellerDetails.builder()
                                        ...
                                        .iecVerificationStatus(sp.getKyc() != null
                                                        ? sp.getKyc().getVerificationStatus().toString()
                                                        : "NOT_VERIFIED")
                                        .kycStatus(sp.getKyc() != null ? sp.getKyc().getVerificationStatus().toString()
                                                        : "NOT_VERIFIED")
        ...
        /**
         * Build UserInfo for login/refresh response (loads seller details if
         * applicable)
         */
        private LoginResponse.UserInfo buildLoginUserInfo(User user) {
                ...
                if (role.equals("SELLER") && user.getSellerProfile() != null) {
                        SellerProfile sp = user.getSellerProfile();
                        iecVerificationStatus = sp.getKyc() != null ? sp.getKyc().getVerificationStatus().toString()
                                        : "NOT_VERIFIED";
        ...
        private void logLoginAttempt(User user, LoginAudit.LoginStatus status, String failureReason, String email,
